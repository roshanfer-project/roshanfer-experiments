...
class Config:
    ...
    prometheus_url: str = "http://192.168.1.100:9091"
    ...
    remote_microservice_host: str = "192.168.1.100"
    remote_microservice_user: str = "farzad"
    remote_microservice_path: str = ""  # /home/farzad/files/ppm/bench/hotel/exec
