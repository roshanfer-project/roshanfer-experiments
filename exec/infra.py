...
class InfraBuilder:
    ...
    def provision_hosts(
        ...
        branch: if set, passed as BRANCH so remotes clone/checkout that branch for both
        roshanfer-experments and benchmarks.
        """
        ...
        try:
            ...
            if branch:
                env["BRANCH"] = branch
                logging.info("Provisioning with BRANCH=%s", branch)
