...
3.  **Deploy**: The system is deployed ONCE per benchmark/system. Supported systems: `plain`, `plain-lb`, `sidecar`, `approx`, `approx-fcfs`, `approx-edf`, `envoy`, `rajomon`, `rajomon-lb`, `dagor`, `dagor-lb`.
